...
If you know a good self-hosted version of any of the mentioned services, create an issue on GitHub or send us an email to [humans@tiptap-es5.dev](mailto:humans@tiptap-es5.dev).
